...
copy flag2.tga flags\medium\%tag%_fascism.tga
copy flag2.tga flags\medium\%tag%_neutrality.tga
copy flag2.tga flags\medium\%tag%_communism.tga
copy flag2.tga flags\medium\%tag%_democratic.tga
del flag2.tga

if not exist flags\small mkdir flags\small
magick convert flag.tga -resize 10x7! flag3.tga
copy flag3.tga flags\small\%tag%_fascism.tga
copy flag3.tga flags\small\%tag%_neutrality.tga
copy flag3.tga flags\small\%tag%_communism.tga
copy flag3.tga flags\small\%tag%_democratic.tga
del flag3.tga